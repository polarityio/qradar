module.exports = {
    ...
    request: {
        ...
        // Relative paths are relative to the IBM QRadar integration's root directory
        cert: '',
         ...
         * to IBM QRadar servers without valid SSL certificates.  Please note that we do NOT recommending setting this
